...
<head runat="server">
    <title>Hotcakes Commerce Installation Wizard</title>
...
<body>
    ...
    <br/>
    <img src="../images/Branding/HCC_logo.png" alt="Hotcakes Commerce" />
                    ...
                    <div class="dnnFormItem">
                        ...
                        <div id="banners">
                            <a id="bannerLink" runat="server" href="" target="">
                                <img id="bannerImage" runat="server" class="banner" src="../images/branding/HCC_logo.png" alt="" onerror="installWizard.bannerError(this);" />
                            </a>
                        </div>
                    </div>
                </div>
    ...
    <script type="text/javascript">
        ...
        function InstallWizard() {
            ...
            this.bannerError = function (image) {
                ...
                if (!/\/images\/branding\/HCC_logo.png$/.test(image.src))
                    image.src = "../images/branding/HCC_logo.png";
            	...
            	installWizard.bannerTimer = setInterval(function () {
                    if (installWizard.bannerIndex != -1) {
                        if (installWizard.bannerIndex == installWizard.bannerMaxIndex) {
                            ...
                            $("#bannerImage").attr("src", "../images/branding/HCC_logo.png");
                            $("#bannerLink").attr("href", "");
                            $("#bannerLink").attr("target", "");
                            $("#bannerLink").click(function () { return false; });
                        }
                        else {
                            $("#bannerLink").unbind('click');
                            $("#bannerImage").attr("src", "https://hotcakes.org/installer/banners/banner_" + installWizard.bannerIndex + ".jpg");
                            if (installWizard.bannerIndex == 2)
                            {
                                $("#bannerLink").attr("href", "http://arrowdigital.com/open-source/hotcakes?ib=" + installWizard.bannerIndex);
                            }
                            else
                            {
                                $("#bannerLink").attr("href", "https://hotcakes.org/?ib=" + installWizard.bannerIndex);
                            }
