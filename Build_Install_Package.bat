...
@echo .
@echo .     Couldn't find proper "MSBuild" to build Hotcakes Commerce.
@echo .     You must have VS 2015 or higher installed to build Hotcakes.
@echo .
@echo .-x-x-x-x-x-x-x-x-x-x-x-x-x-x-x-x-x-x-x-x-x-x-x-x-x-x-x-x-x-x-x-x-
@echo .
...
@echo .-x-x-x-x-x-x-x-x-x-x-x-x-x-x-x-x-x-x-x-x-x-x-x-x-x-x-x-x-x-x-x-x-
@echo .
@echo . Building Hotcakes Commerce using
@echo .    "%builder%"
@echo .
@echo .-x-x-x-x-x-x-x-x-x-x-x-x-x-x-x-x-x-x-x-x-x-x-x-x-x-x-x-x-x-x-x-x-
@echo .

.nuget\NuGet.exe restore HCC_Platform.sln
