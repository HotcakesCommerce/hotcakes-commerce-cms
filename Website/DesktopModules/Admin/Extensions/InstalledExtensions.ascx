                    ...
                    <Columns>                      
                        ...
                        <asp:TemplateColumn HeaderText="InUse">
                            ...
                            <ItemTemplate>
                                ...
                                <asp:Label ID="lblUpgrade" runat="server" CssClass="spnUpgradeImage" Text='<%# UpgradeService((Version)DataBinder.Eval(Container.DataItem,"Version"),DataBinder.Eval(Container.DataItem,"PackageType").ToString(),DataBinder.Eval(Container.DataItem,"Name").ToString()) %>' ></asp:Label>
                            </ItemTemplate>
                        </asp:TemplateColumn>
                        <asp:TemplateColumn HeaderText="Upgrade" Visible="false">
